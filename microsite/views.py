...
from .serializers import (
    MicrositeBrandSerializer,
    MicrositeEntrySerializer,
    MicrositeEntrySiteSerializer,
)


class MicrositeBrandViewSet(
    ...
    def get_queryset(self):
        ...
        return MicrositeBrand.objects.filter_by_user_perms(user, "view_microsite_brand")
    ...
    def add_entry(self, request, pk, *args, **kwargs):
        ...
        if not product_id:
            return Response({"errors": "No id"}, status=status.HTTP_400_BAD_REQUEST)
    ...
    def site_data(self, request, pk, *args, **kwargs):
        ...
        wtb_entities_dict = {
            ...
            .select_related(
                "product__instance_model__model__category", "category", "brand"
            )
            .order_by("-pk")
        }
        ...
        entities = (
            ...
            .select_related(
                "active_registry", "product__instance_model", "product__brand"
            )
        )
