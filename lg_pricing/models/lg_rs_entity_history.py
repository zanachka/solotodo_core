...
class LgRsEntityHistory(models.Model):
    ...
    seller = models.CharField(blank=True, null=True, max_length=256)
    ...
    def synchronize_with_db_entity_histories(cls):
        ...
        active_history_ids = [x.entity_history_id for x in active_histories_in_rs]
        print("Found {} active entries in Redshift".format(len(active_history_ids)))
        ...
        print("Setting {} entries as inactive".format(len(inactive_entity_ids)))
        ...
        last_synchronization = cls.objects.aggregate(Max("timestamp"))["timestamp__max"]
